...
function TradingViewWidget({ height = '500px' }: TradingViewWidgetProps) {
  ...
  useEffect(
    () => {
      ...
      const widgetRoot = widgetContainer?.querySelector<HTMLDivElement>('.tradingview-widget-container__widget');
